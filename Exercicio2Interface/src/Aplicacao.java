...
public class Aplicacao { //classe main para aplicação dos métodos
	...
	public static void main(String[] args) {
		...
		ContaCorrente contacorrente = new ContaCorrente(); //objeto contacorrente instanciado. É da classe ContaCorrente
		...
		containvestimento.depositar(30);     //depositar 200 reais no saldo da containvestimento
		containvestimento.transferir(40);    //transferir 40 reais no saldo da containvestimento
		containvestimento.sacar(20);         //sacar 200 reais no saldo da containvestimento
